...
* [Python IDLE editor download & install](https://python.org/), or 
* [Python & Turtle online with Repl](https://repl.it/languages/python_turtle)

Lessons:

Access the Youtube playlist here

![](img/turtle-videos-qr-code.png)

* Video: [Python with turtle 01: Your first program, drawing basic shapes](https://youtu.be/iQTSa1kWekI)
* Video: [Python with turtle 02: Circles and colors](https://youtu.be/3dOKmmyy2ec)
* Video: [Python with turtle 03: Functions](https://youtu.be/RRLM9yEKcn4)
* Video: [Python with turtle 04: For loops using range](https://youtu.be/idwb45VAp3A)
* Video: [Python with turtle 05: Conditional execution with if](https://youtu.be/QK0EdKOTCl4)
* Video: [Python with turtle 06: For loops with lists, and elif](https://youtu.be/cKYNQ0bmPno)
* Video: [Python with turtle 07: Mouse events](https://youtu.be/VqFXR3D-E-o)
* Get the final version of [tic-tac-toe](/python/sample-tictactoe-turtle.pdf)
...
layers = numinput("Layers?", "How many layers of snowflake would you like me to draw?")
drawFlake(200,layers)
```

# Example 2

The tic tac toe game from the final video can be found [here](/python/sample-tictactoe-turtle)
