...
* [Exercises](oop-exercises) **TODO**
* [Solutions](teacher)

## Exercise: Student's books
...
*   Each **Book** should have several properties:
	...
	*  Author
	*  Read (true or false)
	*  Read date, can be blank, otherwise needs to be a [LocalData object](https://pbaumgarten.com/java/java-datetime/)
...
* Extension 1:  Read in a CSV file of books on program start. 
   ...
   * Import the library into your project, by putting the JAR file in the root folder of your Java projects. 
   * Add a reference to the JAR file in your class path settings when compiling and executing.  (on Mac, replace the `;` with `:`).

```bash
javac -d bin -cp bin;commons-csv-1.6.jar src/com/pbaumgarten/oopbasicsqu2/BookList.java
java -cp bin;commons-csv-1.6.jar com.pbaumgarten.oopbasicsqu2.BookList
```
...
## Exercise: Province animal registrations

* TO-DO: Animal, Dog, cat, for provincial registrations array. (breed, age, color, name, expiryDate)

## Exercise: Hotel reservations

* TO-DO: Rooms, suites, bookings register, customer, loyalty scheme.
